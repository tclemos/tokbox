...
// Role type - https://tokbox.com/developer/guides/create-token/#role
type Role string

const (
	//Publisher role allows the holder to publish streams, subscribe to streams, and signal.
	Publisher Role = "publisher"

	//Subscriber role allows the holder to only subscribe to streams.
	Subscriber = "subscriber"

	// Moderator role in addition to the privileges granted to a publisher,
	// in clients using the OpenTok.js 2.2 library, a moderator can call the
	//  <code>forceUnpublish()</code> and <code>forceDisconnect()</code> method
	// of the Session object.
	Moderator = "moderator"
)

// Session represents a Tokbox session - https://tokbox.com/developer/sdks/js/reference/Session.html
type Session struct {
